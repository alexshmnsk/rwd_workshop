...
# data
df.raw <- read.csv('D:/Study/R programming WD/alex-rmd/data/journals.csv')
...
<!-- paragraph 1 -->
Turpis aliquam ante dictum, viverra. Aliquam velit auctor efficitur nascetur diam. Quis eu donec. Auctor curabitur ut. Elementum est sed et. Curae cras ac nibh.
...
```{r, screenshot, fig.cap = "A screenshot of the Google Scholar homepage \\label{google}", fig.align = "center", out.width="40%"}
knitr::include_graphics('D:/Study/R programming WD/alex-rmd/image/google_scholar.png')
```
...
<!-- figure 2 -->
```{r, image, fig.cap = "Geographic distribution of journals \\label{geography}"}
...
stargazer(data = df, type = 'latex', summary = T, header = F, 
...
stargazer(data = list(lm1,lm2,lm3,lm4), type = 'latex',
          header = F, title = 'Regression results',
          keep.stat = c('n','rsq'),
